...
const (
	...
	FreeBusyViewTypeDetailed FreeBusyViewType = `Detailed`
	...
	FreeBusyViewTypeDetailedMerged FreeBusyViewType = `DetailedMerged`
	...
	FreeBusyViewTypeFreeBusy FreeBusyViewType = `FreeBusy`
	// Represents all the properties in FreeBusy with a stream of merged free/busy availability information.
	FreeBusyViewTypeFreeBusyMerged FreeBusyViewType = `FreeBusyMerged`
	...
	FreeBusyViewTypeMergedOnly FreeBusyViewType = `MergedOnly`
	// This value is not valid for requests. This value is valid for responses.
	FreeBusyViewTypeNone FreeBusyViewType = `None`
)
