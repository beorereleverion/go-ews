...
type ReceiveCopiesOfMeetingMessages bool

const (
	// false
	ReceiveCopiesOfMeetingMessagesfalse ReceiveCopiesOfMeetingMessages = false
	// true
	ReceiveCopiesOfMeetingMessagestrue ReceiveCopiesOfMeetingMessages = true
)
