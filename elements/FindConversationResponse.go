...
// The FindConversationResponse element defines a response to a FindConversation operation request.
// https://learn.microsoft.com/en-us/exchange/client-developer/web-service-reference/findconversationresponse
import "encoding/xml"
