...
type DelegatePermissions struct {
	...
	CalendarFolderPermissionLevel *CalendarFolderPermissionLevel `xml:"t:CalendarFolderPermissionLevel"`
	...
	ContactsFolderPermissionLevel *ContactsFolderPermissionLevel `xml:"t:ContactsFolderPermissionLevel"`
	...
	InboxFolderPermissionLevel *InboxFolderPermissionLevel `xml:"t:InboxFolderPermissionLevel"`
	...
	JournalFolderPermissionLevel *JournalFolderPermissionLevel `xml:"t:JournalFolderPermissionLevel"`
	...
	NotesFolderPermissionLevel *NotesFolderPermissionLevel `xml:"t:NotesFolderPermissionLevel"`
	...
	TasksFolderPermissionLevel *TasksFolderPermissionLevel `xml:"t:TasksFolderPermissionLevel"`
}
